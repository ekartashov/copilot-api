...
describe("Token Management", () => {
  ...
  beforeEach(async () => {
    ...
    getUserSpy = spyOn(
      await import("../../src/services/github/get-user"),
      "getGitHubUser",
    )
    getUserSpy.mockResolvedValue({ login: "test-user", id: 12345 })

    getCopilotTokenSpy = spyOn(
    ...
    getDeviceCodeSpy = spyOn(
      await import("../../src/services/github/get-device-code"),
      "getDeviceCode",
    )
    ...
    pollAccessTokenSpy = spyOn(
      await import("../../src/services/github/poll-access-token"),
      "pollAccessToken",
    )
